    ...
    <section class="content container-fluid">
      ...
      <div class="row"> <!-- row는 하위 div를 12개를 사용 할 수 있다. -->
    		...
    		<div class="col-md-12">
							...
							<form role="form" method="post" action="/admin/product/pro_insert" enctype="multipart/form-data">
								<div class="box-body">
									<div class="form-group row">
										<label for="title" class="col-md-2">카테고리</label>
                    <div class="col-md-3">
                    ...
                    <div class="col-md-3">
                      <select class="form-control" id="secondCategory" name="cg_code">
                        <option>2차 카테고리 선택</option>
									...
									<div class="form-group row">
										<label for="title" class="col-md-2">상품명</label>
                    <div class="col-md-4">
                      <input type="text" class="form-control" name="pro_name" id="pro_name" placeholder="상품명 입력...">
                    </div>
                    <label for="title" class="col-md-2">상품가격</label>
                    <div class="col-md-4">
                      <input type="text" class="form-control" name="pro_price" id="pro_price" placeholder="상품 가격 입력...">
                    </div>
									</div>

									<div class="form-group row">
										<label for="title" class="col-md-2">할인율</label>
                    <div class="col-md-4">
                      <input type="text" class="form-control" name="pro_discount" id="pro_discount" placeholder="할인율 입력...">
                    </div>
                    <label for="title" class="col-md-2">제조사</label>
                    <div class="col-md-4">
                      <input type="text" class="form-control" name="pro_publisher" id="pro_publisher" placeholder="제조사 입력...">
									...
									<div class="form-group row">
                    <label for="title" class="col-md-2">미리보기</label>
                    <div class="col-md-4">
                      <img id="img_preview" style="width: 200px; height: 200px;">
                    </div>
										<label for="title" class="col-md-2">상품 이미지</label>
                    <div class="col-md-4">
                  ...
                  <div class="form-group row">
                    <label for="title" class="col-md-2">상품 설명</label>
                    <div class="col-md-10">
    ...
    var ckeditor_config = {
      ...
      $("#firstCategory").change(function() {
        ...
        $.getJSON(url, function(secondCategoryList) {
          ...
          // console.log("2차 카테고리 갯수", secondCategoryList.length);
          ...
          // finde("css선택자") : 태그명, id속성이름, class속성이름
      ...
      // 파일 첨부시 이미지 미리보기
      // 파일 첨부에 따른 이벤트 관련 정보를 event라는 매개변수를 통하여 참조가 됨.
      $("#uploadFile").change(function(event) {
        let file = event.target.files[0]; // 선택 파일 중 첫번째 파일.
        
        let reader = new FileReader(); // 첨부된 파일을 이용하여, File객체를 생성하는 용도.
  
        reader.readAsDataURL(file); // reader 객체에 파일정보가 할당.
