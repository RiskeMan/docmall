                    ...
                    <div class="box">
                      ...
                      <div class="box-body">
                        ...
                        <div>
                          ...
                          <!--2)목록에서 상품 이미지 또는 상품명을 클릭할 때 사용 s-->
                          <div>
                          ...
                          <div class="col-md-8">
                            <form action="/admin/order/order_list" method="get">
                              <select name="type">
                                ...
                                <option value="P" ${pageMaker.cri.type=='P' ? 'selected' : '' }>결제상태</option>
                      ...
                      <div class="box-footer clearfix">
                        <div class="row">
                          <div class="col-md-4">
                            <button type="button" class="btn btn-primary" id="btn_check_modify1"
                              role="button">체크상품수정1</button>
                            <button type="button" class="btn btn-primary" id="btn_check_modify2"
                              role="button">체크상품수정2</button>
                          </div>
                          ...
                          <div class="col-md-2"><button type="button" class="btn btn-primary" id="btn_pro_insert"
            ...
            $(document).ready(function () {
              ...
              $("#btn_check_modify1").on("click", function () {
                ...
                $.ajax({
                  ...
                  dataType: 'text', // text, HTML, XML, JSON, Plain Text, Images, Binary Data, JSON with Padding
                  success: function (result) {
                    if (result == "success") {
                      alert("체크상품이 수정되었습니다.")

                      // DB에서 다시 불러오는 작업.
                      // 1) location.href = "/admin/product/pro_list"; // 링크 새로 불러와 갱신하기.
                      // 2) 현제 리스트 상태로 불러오는 의미.
                      /*
                      actionForm.attr("method", "get");
              ...
              // 상품 등록 버튼 클릭 /admin/product/pro_insert btn_pro_insert
              $("#btn_pro_insert").on("click", function () {
                // 원하는 URL로 이동
                window.location.href = "/admin/product/pro_insert";
              });
              ...
              $(".btn_order_detail").on("click", function() {
                ...
                // console.log("주문번호", ord_code); // 확인 못함.
              })

              let cur_tr = $(this).parent().parent();
              let url = `/admin/order/order_list/` + ord_code;
