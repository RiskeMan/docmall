...
//		log.info("주문정보 : " + o_vo);
	    ...
	    orderService.order_insert(o_vo, p_vo); // 주문, 상세정보 저장, 장바구니 삭제, 결제정보 저장
	...
	// 무통장 입금
	@GetMapping("nobank")
	public ResponseEntity<String> nobank(String paymethod, OrderVO o_vo, PaymentVO p_vo, int totalprice, HttpSession session) {
